...
- FAZ 2: ✅ (2026-06-13) — DB: otel_hotels.slug + public_settings JSONB + web_published. API: /api/public/otel/[slug] (landing data), /availability (boş oda+fiyat), /book (rez talep). /api/otel-panel/website (GET/PATCH). UI: /[locale]/o/[slug] public landing (hero+oda tipleri+galeri+olanaklar+iletişim), /rezervasyon (3-step booking form), /onay/[id] (başarı). Sahibi yönetim: otel-website sayfası (slug+yayın+hero+galeri+olanaklar+iletişim). Sidebar +Web Sitesi link.
- FAZ 3: ⏳ · FAZ 4: ⏳ · FAZ 5: ⏳ · FAZ 6: ⏳ (Çağrı testi)
