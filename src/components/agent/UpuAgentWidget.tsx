    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-4 right-4 z-50 w-14 h-14 rounded-full bg-gradient-to-br from-emerald-500 to-indigo-600 text-white shadow-lg hover:shadow-xl active:scale-95 transition flex items-center justify-center"
        >
          <Bot className="w-6 h-6" strokeWidth={2.2} />
        </button>
      )}
