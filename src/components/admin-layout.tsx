        ...
        <header className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-800/50 sticky top-0 z-20">
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="flex items-center gap-2 text-slate-500">
              ...
              <div className="hidden sm:flex items-center gap-2 pl-2 border-l border-slate-200 dark:border-slate-800/50">
                <div className={`w-8 h-8 rounded-full ${accent.avatar} flex items-center justify-center text-sm font-semibold`}>
                  {firstName.charAt(0).toUpperCase() || "?"}
                </div>
                <span className="text-sm text-slate-700 dark:text-slate-300">{firstName || "—"}</span>
              </div>
            </div>
          </div>
        </header>
