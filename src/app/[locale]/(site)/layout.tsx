...
const SITE_SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { id: "bakim",     label: "Bakım Takvim",     icon: "🛠", href: t => `/tr/site-bakim?t=${encodeURIComponent(t)}`, matchPath: "/tr/site-bakim" },
  ...
  { id: "profil",    label: "Profil & Ayarlar", icon: "⚙️",  href: t => `/tr/site-ayarlari?t=${encodeURIComponent(t)}`, matchPath: "/tr/site-ayarlari" },
];
