...
function SahibindenTutorialCard() {
  ...
  const STEPS = [
    ...
    { n: "4️⃣", title: "Eklentiyi panele bağlayın", desc: "Eklenti ikonuna tıklayın, panelinizden aldığınız bağlantı kodunu girin.", link: { url: "/tr/eklenti", label: "🧩 Bağlantı Kodumu Gör →" } },
    { n: "5️⃣", title: "sahibinden.com'da ilan ver sayfasına gidin", desc: "Yeni sekmede ilan ver sayfasını açın.", link: { url: "https://banaozel.sahibinden.com/ilan-ver/adim-1/?state=new", label: "🌐 Yeni sekme →" } },
