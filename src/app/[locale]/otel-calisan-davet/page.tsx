    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-24">
      <div className="max-w-md mx-auto p-4">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-4 mb-4 space-y-3">
          ...
          <div>
            <label className="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">Pozisyon (rol)</label>
          ...
          {init && init.hotels.length > 1 && (
            <div>
              <label className="block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">Otel *</label>
