...
export default function BayiKampanyaPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/bayi-kampanya/init${qs}`, { credentials: "same-origin" })
      .then(async r => {
  ...
  return (
    <div className="pb-24">
      <div className="max-w-md mx-auto">
        <div className="bg-gradient-to-br from-orange-600 to-pink-600 text-white rounded-2xl p-5 mb-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button onClick={save} disabled={status === "saving"}
            className="bg-orange-600 text-white py-3 rounded-xl font-semibold disabled:opacity-60 active:scale-95">
