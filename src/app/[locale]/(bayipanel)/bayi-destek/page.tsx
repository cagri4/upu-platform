...
/**
 * Destek Talebi — bayi tenant kopyası (placeholder).
 */

export default function BayiDestekPage() {
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm text-center">
        <div className="text-6xl mb-4">🛟</div>
        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-2">Destek Talebi</h1>
