  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Odalar</h1>
            ...
            return (
              <div key={r.id} className="bg-white dark:bg-slate-800 rounded-2xl p-4 shadow-sm">
                <div className="flex items-start justify-between mb-2">
                  <div className="text-lg font-bold text-slate-900 dark:text-slate-100">🚪 {r.name}</div>
                ...
                <div className="text-xs text-slate-600 dark:text-slate-400 space-y-0.5">
                  ...
                  {r.base_price !== null && <div className="font-semibold text-slate-900 dark:text-slate-100 mt-1">{Number(r.base_price).toLocaleString("tr-TR")} ₺ <span className="text-[10px] text-slate-500">/gece</span></div>}
                </div>
              </div>
            );
          })}
