    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl p-6 text-center shadow-sm">
        ...
        <p className="text-sm text-slate-500">
          ...
          <span className="font-mono bg-slate-100 px-1.5 py-0.5 rounded">kasarapor</span>
          ,{" "}
          <span className="font-mono bg-slate-100 px-1.5 py-0.5 rounded">raporgunluk</span>
          {" "}veya{" "}
          <span className="font-mono bg-slate-100 px-1.5 py-0.5 rounded">topsatan</span>
