/**
 * Shared helpers for siteyonetim agent tool handlers.
...
/**
 * Helper to get user's building (shared across all SY agents).
 */
export async function getUserBuilding(ctx: AgentContext) {
  const supabase = getServiceClient();
