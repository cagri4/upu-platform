...
export const temizlikDataset: SectorDataset = {
  ...
  dealers: [
    { name: "Hijyen Toptan",       city: "Ankara",   country: "TR", contact_name: "Mehmet Hijyen",   contact_phone: "905321150001", is_active: true, balance: 3400, status_note: "Düzenli alım" },
    { name: "Aytaç Market",        city: "Bursa",    country: "TR", contact_name: "Aytaç Yıldız",    contact_phone: "905321150002", is_active: true, balance: 1850, status_note: "Düzenli, küçük cari" },
    { name: "Yılmaz Temizlik",     city: "Adana",    country: "TR", contact_name: "Veli Yılmaz",     contact_phone: "905321150003", is_active: true, balance: 8500, status_note: "KRİTİK — 12 gün geçmiş vade" },
    { name: "Mehmet Hijyen Tek.",  city: "Konya",    country: "TR", contact_name: "Mehmet Tezcan",   contact_phone: "905321150004", is_active: true, balance: 920,  status_note: "Yeni cari, büyüyor" },
    { name: "Asya Bakım Ürünleri", city: "İstanbul", country: "TR", contact_name: "Asya Demirtaş",   contact_phone: "905321150005", is_active: true, balance: 5200, status_note: "Büyük zincir, kurumsal" },
  ],
