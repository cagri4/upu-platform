...
export const gidaDataset: SectorDataset = {
  ...
  dealers: [
    {
      name: "Anadolu Gıda Toptan", city: "Adana", district: "Seyhan", country: "TR",
      contact_name: "Mehmet Akın", contact_phone: "905321120001", email: "info@anadolugida.com",
      address_line: "Atatürk Bulvarı 245", is_active: true, balance: 3200,
      tax_number: "2234567890", tax_office: "Seyhan Vergi Dairesi",
      iban: "TR230006400000111122233344", credit_limit: 15000, payment_term_days: 60,
      discount_rate: 10, risk_status: "clean", tags: ["VIP"],
      status_note: "Düzenli alım",
    },
    {
      name: "Mehmet Bakkal", city: "Konya", district: "Karatay", country: "TR",
      contact_name: "Mehmet Tezcan", contact_phone: "905321120002", email: "mehmet@bakkal.com",
      address_line: "Karaçam Sok. 18", is_active: true, balance: 480,
      tax_number: "2234567891", tax_office: "Karatay Vergi Dairesi",
      iban: "", credit_limit: 3000, payment_term_days: 30, discount_rate: 0,
      risk_status: "clean", tags: ["yeni"],
      status_note: "Küçük dükkan, haftalık alım",
    },
    {
      name: "Ege Toptan Gıda", city: "İzmir", district: "Bornova", country: "TR",
      contact_name: "Hasan Yenice", contact_phone: "905321120003", email: "hasan@egetoptan.com",
      address_line: "Sanayi Sitesi 4. Cad. 32", is_active: true, balance: 9200,
      tax_number: "2234567892", tax_office: "Bornova Vergi Dairesi",
      iban: "TR890012300099988877766655", credit_limit: 12000, payment_term_days: 30,
      discount_rate: 6, risk_status: "watch", tags: ["kritik"],
      status_note: "KRİTİK — 14 gün geçmiş vade",
    },
    {
      name: "Yılmaz Gıda", city: "Bursa", district: "Yıldırım", country: "TR",
      contact_name: "Veli Yılmaz", contact_phone: "905321120004", email: "veli@yilmazgida.com",
      address_line: "Cumhuriyet Cad. 67", is_active: true, balance: 1850,
      tax_number: "2234567893", tax_office: "Yıldırım Vergi Dairesi",
      iban: "TR340004600118000111222333", credit_limit: 10000, payment_term_days: 45,
      discount_rate: 9, risk_status: "clean", tags: [],
      status_note: "Düzenli, normal cari",
    },
    {
      name: "Aysu Market Zinciri", city: "İstanbul", district: "Ümraniye", country: "TR",
      contact_name: "Aysu Demirtaş", contact_phone: "905321120005", email: "aysu@aysumarket.com.tr",
      address_line: "Ataşehir Bulvarı 12-A", is_active: true, balance: 5400,
      tax_number: "2234567894", tax_office: "Ümraniye Vergi Dairesi",
      iban: "TR560010009998765432101001", credit_limit: 25000, payment_term_days: 90,
      discount_rate: 14, risk_status: "clean", tags: ["VIP", "kurumsal"],
      status_note: "Büyük zincir, aylık ödeyici",
    },
  ],
