 ...
 * Kampanyalarım, Cirolarım, Takvim, Profilim. Alt grup (UPUDev/Öneri/Destek)
 * Dalga 2'de eklenecek (bayi-hakkinda, bayi-oneri, bayi-destek sayfaları
 * henüz yok — emlak `(panel)` ile path çakışmaması için tenant prefix
 * kullanılıyor).
 *
